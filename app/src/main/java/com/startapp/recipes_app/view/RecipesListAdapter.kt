...
internal class RecipesDiffCallback : DiffUtil.ItemCallback<RecipesView.ViewModel>() {
    ...
    override fun areItemsTheSame(
        ...
        true // they are the same kind of item
...
internal class RecipesListAdapter(private val interactions: RecipesView.Interactions) :
    ListAdapter<RecipesView.ViewModel, RecipeViewHolder>(RecipesDiffCallback()) {
    /**
